...
void *read_another_1(void *arg)
{
	...
	if(nret != 27)
	{
		syslog(LOG_DEBUG, "err: read_another_1 read fail");
	}
	else
...
void *write_another_1(void *arg)
{
	...
	{
		syslog(LOG_DEBUG, "err: write_another_1 write fail");
	}
	else
...
void *read_another_2(void *arg)
{
	...
	if(nret != 27)
	{
		syslog(LOG_DEBUG, "err: read_another_2 read fail");
	}
	else
...
void *read_another_3(void *arg)
{
	...
	if(nret != 27)
	{
		syslog(LOG_DEBUG, "err: read_another_3 read fail");
	}
	else
